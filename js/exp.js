var exp = (function() {
    ...
    */
    ...
    function MakeTaskInstructions(gameType, gameName_1, gameName_2, color, hex, roundLength, pM, round, nOddBall) {
    ...
    p.round1_howToEarn = new MakeTaskInstructions(settings.gameType, settings.gameName_1, settings.gameName_2, settings.color_1, settings.hex_1, settings.roundLength, settings.pM, 1, settings.nOddBall);
    ...
    p.round2_howToEarn = new MakeTaskInstructions(settings.gameType, settings.gameName_1, settings.gameName_2, settings.color_2, settings.hex_2, settings.roundLength, settings.pM, 2, settings.nOddBall);
    ...
    */
    ...
    p.practice1 = new dmPsych.MakeTileGame(settings.hex_1, settings.tileHit_1, settings.tileMiss, settings.roundLength, settings.gameType, 10, settings.pM_practice, 'practice', 0, settings.nOddBall[0]);

    p.round1 = new dmPsych.MakeTileGame(settings.hex_1, settings.tileHit_1, settings.tileMiss, settings.roundLength, settings.gameType, settings.nTrials, settings.pM, 'tileGame', 1, settings.nOddBall[0]);

    p.round2 = new dmPsych.MakeTileGame(settings.hex_2, settings.tileHit_2, settings.tileMiss, settings.roundLength, settings.gameType, settings.nTrials, settings.pM, 'tileGame', 2, settings.nOddBall[1]);
